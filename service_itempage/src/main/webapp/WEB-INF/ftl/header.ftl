                ...
                <div class="shortcut">
                    <ul class="fl" v-if="user==''">
                        ...
                        <li class="f-item"> 请<a href="/cas/login" style="padding-left: 10px;"
                                        ...
                                        href="http://localhost:8088/register.html" target="_blank">免费注册</a></span>
                        </li>
                    </ul>
                    ...
                    <ul class="fr">
                        <li class="f-item"><a href="http://localhost:8082/orderInfo.html">我的订单</a></li>
                        <li class="f-item space"></li>
                        <li class="f-item"><a href="http://localhost:8082/cart.html">我的购物车</a></li>
                        <li class="f-item space"></li>
